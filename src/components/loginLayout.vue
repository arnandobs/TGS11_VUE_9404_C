                            ...
                            <v-row>
                                <v-col cols="6">
                                    ...
                                    <div class="form">
                                                ...
                                                <div>
                                                    ...
                                                    <v-tooltip bottom>
                                                        <template v-slot:activator="{ on }">
                                                            <a target="_blank" href="http://instagram.com/arnandobezaliel"
                                                                @click.stop v-on="on">
                                        ...
                                        <v-btn @click="login()" rounded block class="elevation-0" color="primary"
                                            height=50 dark> Sign in Now </v-btn>
                                    </div>
